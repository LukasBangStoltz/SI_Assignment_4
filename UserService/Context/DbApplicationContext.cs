    ...
    public class DbApplicationContext : DbContext
    {
        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>()
                ...
                .HasConversion(new EnumToStringConverter<Common.Enums.Enums.RoleTypes>());

            // Dummy data
            modelBuilder.Entity<Role>()
                .HasData(
                    new Role { Id = 1, RoleType = Common.Enums.Enums.RoleTypes.Customer },
                    new Role { Id = 2, RoleType = Common.Enums.Enums.RoleTypes.DeliveryPerson },
                    new Role { Id = 3, RoleType = Common.Enums.Enums.RoleTypes.RestaurantOwner });
